...
- [2026-04-24 10:30 | Claude-Console] CloserX sweep COMPLETE: "AI Call Agent" (app ID 669fa047e5605344754496bc, dev=closerx.ai) uninstalled Agency+ABC+EqM. JS injection confirmed gone both subs. ABC: 3 websites clean, 0 funnels, 9 AI agents clean, workflows search=0 hits. EqM: 5 websites clean, 2 funnels clean, 17 AI agents clean (Voice AI Bots x6, General Business Automation x10, Mortgage Pre-Qualifier x1), workflows search=0 hits. Both subs fully clean.
- - [2026-04-24 10:31 | Claude-Console] Phase 1 Killswitch Workflows — STARTING. Scope: ABC rename 2 existing Voice AI drafts + build 6 fresh (SMS/Email/AllOutreach pairs); EqM build 8 fresh. New-build-only — no legacy workflow edits.
